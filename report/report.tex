...
\begin{equation}\label{eq:position}
    ...
    \end{bmatrix}.
\end{equation}
The velocity of a given material point $(u,v)$ as the active end of the ribbon is displaced (i.e., as $x$ changes) is then obtained by differentiating each component of Eq.~\eqref{eq:position} with respect to $x$:
